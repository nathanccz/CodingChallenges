...
//Error handling: The fromRoman method should not produce a value if the string is an invalid Roman numeral. To check for valid strings, call this.toRoman() and pass in the sum generated by the fromRoman method. If there is a discrepancy between the the this.toRoman(sum) result and the original string passed into the FromRoman method, throw a new error. 
